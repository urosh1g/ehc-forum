...
export class ThreadsController {
  ...
  @Get(':id')
  fetchOne(@Param('id', ParseIntPipe)id:number, @Query() query: ThreadQuery): Promise<Thread> {
  ...
  @Patch(':id')
  update(@Param('id', ParseIntPipe)id: number, @Body()dto: UpdateThread): Promise<Thread> {
